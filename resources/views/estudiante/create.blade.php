...
@section('page_title', 'Nuevo Estudiante')
...
<div class="page-content browse container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('estudiantes.store') }}" id="formEstudiante" method="post">
                        @csrf
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('codigoEstudiante') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="codigoEstudiante" id="codigoEstudiante" value="{{ old('codigoEstudiante') }}" required class="form-control">
