                ...
                <div class="card-body">
                    <table class="table table-striped" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $profesor->user->identification }}</td>
                                <td>{{ $profesor->user->name }}</td>
                                <td>{{ $profesor->user->surname }}</td>
                                <td>{{ $profesor->user->email }}</td>
                                <td>{{ $profesor->estado == 'i' ? 'Inactivo' : 'Activo'}}</td>
                                <td>
                                    <div class="actions">
                                        <a href="{{ route('profesores.edit', $profesor->id) }}" class="btn btn-sm btn-primary pull-right edit">
