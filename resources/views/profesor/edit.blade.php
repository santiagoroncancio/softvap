...
@section('page_title', 'Editar Profesor')
...
<div class="page-content browse container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('profesores.update', $prof->id) }}" id="formProfesor" method="post">
                        @csrf
                        {{ method_field('PUT') }}
                        <fieldset>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('estado') ? 'has-error' : '' }}">
                                        ...
                                        <select name="estado" id="estado" required class="form-control select2">
                                            ...
                                            <option value="a" @if($prof->estado == 'a') selected @endif >Activo</option>
                                            <option value="i" @if($prof->estado == 'i') selected @endif>Inactivo</option>
                                        </select>
