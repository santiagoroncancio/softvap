                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="identification" name="identification" placeholder="Identificación" value="{{ old('identification', $dataTypeContent->identification ?? '') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="surname" name="surname" placeholder="Apellido" value="{{ old('surname', $dataTypeContent->surname ?? '') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="additional_roles">{{ __('voyager::profile.roles') }}</label>
                            @php
                            $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
